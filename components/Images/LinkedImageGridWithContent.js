...
export const LinkedImageGridWithContent = ({
      ...
      {linkedImageGridItems &&
        linkedImageGridItems.map((linkedImageGridItem, index) => {
          ...
          if (linkedImageGridItem.heading) {
            return (
              <div
                className="w-1/3 aspect-square flex flex-col justify-center p-8 text-center relative z-10 before:content-[' '] before:absolute before:top-0 before:right-0 before:bottom-0 before:left-0 before:bg-grayPurple before:-z-10 before:scale-110"
              ...
              >
                ...
                <Link href={linkedImageGridItem.link} passHref>
                  <a
                    className="uppercase text-darkPurple font-bold no-underline"
                    href={linkedImageGridItem.link}
                  >
